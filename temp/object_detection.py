...
from helper import FPS, WebcamVideoStream, SessionWorker
...
allowMemGrth = cfg['allowMemGrth']
detInterval = cfg['detInterval']
thres = cfg['thres']
                ...
                if counts % 1 == 0:
                    if splitModel:
                        ...
                        if gpu_worker.sessEmpty():
                            # read video frame, expand dimensions and convert to
                            # rgb
